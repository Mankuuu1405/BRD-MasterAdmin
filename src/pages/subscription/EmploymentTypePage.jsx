...
export default function EmploymentTypePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (panelMode === "add") {
      await employmentTypeService.create(form);
    } else if (panelMode === "edit") {
      await employmentTypeService.update(selectedUUID, form);
    }
          ...
          filtered.map((item) => (
            ...
            >
              ...
              <div className="relative group">
                ...
                <div className="hidden group-hover:block absolute right-0 top-8 w-36 bg-white border shadow-xl rounded-xl z-20">
                  <button
